    ...
    <section className="bg-white px-20 py-16">
      <div className="container mx-auto text-center">
        ...
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
          Lorem ipsum odor amet, consectetur adipiscing elit. Placerat porttitor
          arcu lacus scelerisque eu nisl aenean torquent porta. Ad vivamus
          interdum ornare; scelerisque purus orci diam ullamcorper. Ante
          ultrices laoreet ad montes litora amet in habitant. Vel rutrum
          ridiculus placerat duis finibus ipsum maximus. Vulputate netus rutrum
          sagittis mattis augue ante.
        </p>
        ...
        <div className="flex flex-wrap justify-between items-end gap-6">
          ...
          <div className="flex flex-col-reverse gap-6 flex-1 min-w-[200px]">
            {/* Sub-Div 1 */}
            <div className="bg-[#035100] text-white rounded-2xl shadow-lg flex flex-col justify-center items-center h-[150px] relative overflow-hidden">
              <Image
                src="/home/hero1.png"
                alt="Pencil"
                fill
            ...
            <div className="relative bg-[#035100] rounded-2xl overflow-hidden shadow-lg flex items-end h-[300px]">
              <h3 className="absolute mb-32 mr-10 bg-[#035100] text-white text-2xl font-bold p-6 z-30">
              ...
              <Image
                ...
                alt="Child Smile"
                fill
                className="object-cover z-20 mt-10 ml-10"
                sizes="(max-width: 768px) 100vw, 33vw"
              />
            </div>
          </div>
