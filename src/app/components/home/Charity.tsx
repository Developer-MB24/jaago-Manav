        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mt-12">
          <div className="text-center md:text-left max-w-xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#035100]">
                  Start Helping Them
                </h3>
            ...
            <div className="mt-12 text-center">
              <p className="text-[#035100] flex items-center justify-center gap-2">
                <span className="text-2xl">✔</span> Helped Fund 3265 Project
                Powerful
              </p>
              <p className="text-[#035100] flex items-center justify-center gap-2 mt-4">
